# Generated by Django 3.2.8 on 2022-04-14 10:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer1', models.CharField(default='Enter your School friend name', max_length=50)),
        ...
        migrations.CreateModel(
            name='PasswordReset',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='onroad.user')),
            ],
        ),
        migrations.CreateModel(
            name='UserReg',
